...
import javacommon.base.AjaxParam;
...
public class ${className}Action extends BaseStruts2Action implements Preparable,ModelDriven{
	...
	public String save() {
		...
		ap.setMessage(CREATED_SUCCESS);
		ap.setCallbackType("closeCurrent");
		ap.setNavTabId("${className}");
		return ajaxForwardSuccess(ap);	
	}
